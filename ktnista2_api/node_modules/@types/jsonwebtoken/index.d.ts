 ...
 */
export function verify(token: string | undefined, secretOrPublicKey: Secret, options: VerifyOptions & { complete: true }): Jwt;
export function verify(token: string | undefined, secretOrPublicKey: Secret, options?: VerifyOptions & { complete?: false }): JwtPayload | string;
export function verify(token: string | undefined, secretOrPublicKey: Secret, options?: VerifyOptions): Jwt | JwtPayload | string;
